...
module.exports.capture = function (option, callback) {
        ...
        ph.createPage(function (page) {
            ...
            page.open(option.uri, function (status) {
                ...
                if (option["inject-script"]) {
                    ...
                    page.evaluate(injectScript, captureFunction);
                } else if (option.waitcapturedelay) {
                    setTimeout(captureFunction, +option.waitcapturedelay);
                } else {
                    captureFunction();
                }
    ...
    ["cookies-file", "web-security", "ignore-ssl-errors", "ssl-protocol"].forEach(function (key) {
        if (option[key]) {
